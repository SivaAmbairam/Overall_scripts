...
if __name__ == '__main__':
    ...
    demo_df = pd.read_csv('Output/Product_Comparison_Manual_export.csv')
    flinn_df = pd.read_csv('Output/Flinn_Products.csv')
    frey_df = pd.read_csv('Output/Frey_products.csv')
    nasco_df = pd.read_csv('Output/Nasco_products.csv')
    carolina_df = pd.read_csv('Output/Carolina_Products.csv')
    vwr_df = pd.read_csv('Output/VWR_WARDS_Products.csv')
    fisher_df = pd.read_csv('Output/Fisher_products.csv')
    wardsci_df = pd.read_csv('Output/Wardsci_products.csv')
    ...
    combined_df.to_csv('Output/Master_file.csv', index=False)