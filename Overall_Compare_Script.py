...
if __name__ == '__main__':
    master_df = pd.read_csv('Output/Master_file.csv')
    other_matched_df = pd.read_csv('Output/Master_Matched_Products.csv')
    updated_rows = []
    ...
    updated_master_df.to_csv('Output/Updated_Master_file.csv', index=False)
