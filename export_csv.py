...
#
# csv_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Product_Comparison_Manual_export.csv')
#
# def export_to_csv(query, csv_file_path):
...
#     export_to_csv(query, csv_file_path)
