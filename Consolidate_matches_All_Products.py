...
def consolidate_matches(input_folder, output_file, supplier_name):
    ...
    with open(output_file, 'w', newline='') as final_file:
        fieldnames = [
            ...
            f'{supplier_name}_product_url', f'{supplier_name}_image_url', 'Match_Score'
        ]
...
def create_master_csv(suppliers, output_folder, output_file_name):
    ...
    for supplier_name in suppliers:
        input_file = os.path.join('Output', 'temp', f'FlinnVs{supplier_name}', 'Matched_Products.csv')
...
consolidate_matches('Output/temp/FlinnVsFrey', 'Output/temp/FlinnVsFrey/Matched_Products.csv', 'Frey')
consolidate_matches('Output/temp/FlinnVsNasco', 'Output/temp/FlinnVsNasco/Matched_Products.csv', 'Nasco')
consolidate_matches('Output/temp/FlinnVsCarolina', 'Output/temp/FlinnVsCarolina/Matched_Products.csv', 'Carolina')
consolidate_matches('Output/temp/FlinnVsVWR', 'Output/temp/FlinnVsVWR/Matched_Products.csv', 'VWR')
consolidate_matches('Output/temp/FlinnVsFisher', 'Output/temp/FlinnVsFisher/Matched_Products.csv', 'Fisher')
consolidate_matches('Output/temp/FlinnVsWardsci', 'Output/temp/FlinnVsWardsci/Matched_Products.csv', 'Wardsci')


suppliers = ['Frey', 'Nasco', 'Carolina', 'VWR', 'Fisher', 'Wardsci']
create_master_csv(suppliers, 'Output', 'Master_Matched_Products.csv')
